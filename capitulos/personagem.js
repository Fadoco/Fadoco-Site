document.addEventListener('DOMContentLoaded', () => {
    ...
    // Busca a lista de capítulos (caminho relativo ao HTML na raiz)
    fetch('capitulos/lista.json')
        ...
        .then(data => {
            ...
            if (lastCapId) {
                ...
                if (lastCap) {
                    ...
                    resumeBtn.href = `capitulos/leitura.html?cap=${lastCap.id}`;
            ...
            data.capitulos.forEach((cap) => {
                ...
                btn.href = `capitulos/leitura.html?cap=${cap.id}`;
